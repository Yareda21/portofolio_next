    ...
    <div className="h-[100vh] w-[100%] bg-primary/30 py-36 flex items-center">
      ...
      <div className="container mx-auto flex justify-center items-center">
        ...
        <div className="hidden text-center md:block xl:w-[30vw] flex-col lg:text-left mb-4 xl:mb-0">
          ...
          <p className="mb-4 max-w-[400px] text-xl lg:text-2xl mx-auto lg:mx-0">
            These are my few projects I have done!! Swipe to see different
            projects with diffrent technologies.
          </p>
        </div>
        {/* slider */}
        <ServiceSlider />
