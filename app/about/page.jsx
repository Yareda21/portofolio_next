            ...
            <div className="container mx-auto h-full flex z-10 flex-col items-center xl:flex-row">
                ...
                <div className="flex-1 flex flex-col justify-center items-center ">
                    ...
                    <p className="hidden md:flex-1 max-w-[500px] text-white xl:mx-0 mb-6 xl:mb-12 px-2 xl:px-0">
                        I thrive on difficult projects that necessitate creative
                        solutions, and I enjoy working with a wide range of
                        programming languages and frameworks, including{" "}
                        <span className="text-accent">
                            {" "}
                            JAVASCRIPT, PYTHON, HTML, CSS, TAILWINDCSS, REACT,
                            EXPO{" "}
                        </span>{" "}
                        and many more..
                    </p>
