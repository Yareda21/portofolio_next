...
export default function Testimony() {
    ...
    return (
        <section class="py-24 px-2 md:px-10 flex h-full items-center justify-center ">
            <div class="container mx-auto px-4">
                <div class="flex flex-col lg:flex-row items-center justify-between">
                    <div class="mb-8 lg:mb-0 lg:w-1/2 mr-5">
                        <h2 class="text-xl md:text-3xl  font-semibold mt-3 mb-5">
                            Welcome to my{" "}
                            <span class="text-blue-200  underline underline-offset-4">
                                Testimonials
                            </span>{" "}
                        </h2>
                        <p class="hidden md:flex font-light text-gray-50 mb-5">
                            Here, you'll find the voices of those I've had the
                            pleasure of working with and teach. From coding to
                            digital marketing, my journey has been enriched by
                            the diverse experiences and feedback from my
